      ...
      <div className="mx-auto grid grid-cols-2 grid-rows-3 gap-6 ">
        <div className=" lg:w-[80%] relative bg-slate-100 px-2 py-2 rounded-md">
          <div className="col-span-1 row-span-3 ">
            ...
            <button className="text-zinc-100 bg-zinc-700 px-5 py-2 rounded-full ml-5 mt-3 hover:opacity-70">
              Learn More
            </button>
          </div>
        </div>
